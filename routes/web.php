...
Route::get('/home/{id}', [App\Http\Controllers\HomeController::class, 'update'])->middleware('user','fireauth');;
// Route::get('/home/{id}',[App\Http\Controllers\HomeController::class, 'index'])->middleware('user','fireauth');;

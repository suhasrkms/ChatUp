          ...
          <div class="card-body contacts_body">
            <ui class="contacts">
              ...
              @foreach ($users as $user)
                @if ($user->uid != $uid)
                  <li>
                    <a href="/home/{{$user->uid}}" class="btn-users btn-block
                      {{$user->uid == $msgUser->uid ? "activeUser" : '' }}
                      ">
                      <div class="d-flex bd-highlight">
                        ...
                        <div class="user_info" onmouseover="">
      ...
      <div class="col-md-8 col-xl-6 chat">
        <div class="card">
          ...
          @if (!$msgUser)
            ...
            <div class="card card-body msgBody">
              <img class="card-img-top" src="assets\img\Empty.png" alt="Card image cap">
            </div>
          ...
          @else
            ...
            <div class="card-footer">
              <div class="input-group">
                <textarea name="" class="form-control type_msg" placeholder="Type your message..." style="border-radius: 15px 0 0 15px !important;"></textarea>
